...
> 📄 本项目采用**代码与素材分离的双重许可结构**，详细条款见 [NOTICE](./NOTICE) 文件。
...
欢迎 Issue 与 PR！在提交代码前请阅读版权声明部分及 [NOTICE](./NOTICE) 文件。
...
Full legal notice and derivative-works guidance: [NOTICE](./NOTICE)
